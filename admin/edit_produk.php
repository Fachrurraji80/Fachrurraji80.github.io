...
<div class="container">
	...
	<form action="proses/edit_produk.php" method="POST" enctype="multipart/form-data">
		...
		<hr>
		<h3 style=" width: 100%; border-bottom: 4px solid gray">Barang Tambahan</h3>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<h4>Pilih Produk yang hanya dibutuhkan untuk produk</h4>
				<div class="bg-danger" style="padding: 5px;">
				<p style="color: red; font-weight: bold;">NB. Form dibawah tidak harus diisi semua</p>
				<p style="color: red; font-weight: bold;">Kode Produk tidak boleh sama</p>
				</div>
				<br>
				<?php 
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="Produk[]" class="form-control" placeholder="Masukkan Kode Produk" value="<?= $row3['kode_bk']; ?>" required>
							</div>
						</div>
