...
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid gray"><b>Master Produk</b></h2>
		...
		<a href="tm_produk.php" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Barang</a>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Paket Tambahan Barang <?= strtoupper($tam['nama']); ?></h4>
				</div>
				<div class="modal-body">
					<table class="table table-striped">
						...
						<th>No</th>
						<th>Nama Barang</th>
						<th>Berat Barang/Stok tersedia</th>
						</tr>
<?php 
